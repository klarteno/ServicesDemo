...
public class MainActivity extends Activity implements ServiceConnection,MusicPlayer.Callback {
    ...
    private MusicPlayer playerController;
    ...
    protected void onPause() {
        ...
        if (playerController != null) {
            playerController.setCallback(null);
            unbindService(this);
        }
    }
    ...
    public void onServiceConnected(ComponentName name, IBinder iBinder) {
        ...
        playerController = ((MusicPlayer.MusicPlayerBinder) iBinder).getService();
    ...
    @Override
    public void onOperationCompleted(ServResult complexResult) {
